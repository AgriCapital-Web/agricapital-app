...
export const PERMISSIONS = {
  ...
  VIEW_DASHBOARD: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.CHEF_EQUIPE, ROLES.COMPTABLE, ROLES.COMMERCIAL, ROLES.TECHNICIEN, ROLES.SERVICE_CLIENT, ROLES.OPERATIONS, ROLES.RESPONSABLE_COMMERCIAL, ROLES.RESPONSABLE_TECHNIQUE_AGRO, ROLES.CHEF_EQUIPE_COMMERCIAL, ROLES.CHEF_EQUIPE_TECHNIQUE],
  VIEW_SOUSCRIPTIONS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.CHEF_EQUIPE, ROLES.COMMERCIAL, ROLES.SERVICE_CLIENT, ROLES.RESPONSABLE_COMMERCIAL, ROLES.CHEF_EQUIPE_COMMERCIAL],
  VIEW_LEADS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.CHEF_EQUIPE, ROLES.COMMERCIAL, ROLES.SERVICE_CLIENT, ROLES.RESPONSABLE_COMMERCIAL, ROLES.CHEF_EQUIPE_COMMERCIAL],
  VIEW_PLANTATIONS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.CHEF_EQUIPE, ROLES.COMMERCIAL, ROLES.TECHNICIEN, ROLES.OPERATIONS, ROLES.RESPONSABLE_TECHNIQUE_AGRO, ROLES.CHEF_EQUIPE_TECHNIQUE],
  VIEW_PAIEMENTS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.COMPTABLE, ROLES.SERVICE_CLIENT, ROLES.RESPONSABLE_COMMERCIAL],
  VIEW_COMMISSIONS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.COMPTABLE, ROLES.RESPONSABLE_COMMERCIAL],
  VIEW_PORTEFEUILLES: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.COMPTABLE],
  VIEW_RAPPORTS_TECHNIQUES: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.TECHNICIEN, ROLES.OPERATIONS, ROLES.RESPONSABLE_TECHNIQUE_AGRO, ROLES.CHEF_EQUIPE_TECHNIQUE],
  VIEW_RAPPORTS_FINANCIERS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.COMPTABLE, ROLES.RESPONSABLE_COMMERCIAL],
  VIEW_TICKETS: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.SERVICE_CLIENT, ROLES.TECHNICIEN, ROLES.OPERATIONS, ROLES.RESPONSABLE_TECHNIQUE_AGRO],
  VIEW_PARAMETRES: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC],
  VIEW_EQUIPES: [ROLES.SUPER_ADMIN, ROLES.DIRECTEUR_TC, ROLES.SUPERVISEUR_TC, ROLES.CHEF_EQUIPE, ROLES.RESPONSABLE_COMMERCIAL, ROLES.RESPONSABLE_TECHNIQUE_AGRO, ROLES.CHEF_EQUIPE_COMMERCIAL, ROLES.CHEF_EQUIPE_TECHNIQUE],
